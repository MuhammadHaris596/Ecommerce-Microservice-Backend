import { Controller, Post, Body, UploadedFile, UseInterceptors, Delete, Param, Get,Put, UseGuards } from '@nestjs/common';
...
export class CategoryController {
  ...
  @Post('addCategory')
    ...
    async createCategory(
      ...
      let addedCategory = file ? {...categoryDto, imageUrl: file.path,imageID: file.filename} : categoryDto;
    ...
    @UploadedFile() file?: Express.Multer.File
      ...
      let updateCategoryData = file ? {...UpdateCategoryDto, imageUrl: file.path,imageID: file.filename} : UpdateCategoryDto;
      let updateData =await this.categoryService.updateCategory(id, updateCategoryData );
