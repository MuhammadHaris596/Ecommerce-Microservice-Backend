...
async function bootstrap() {
  ...
  await app.startAllMicroservices()
   ...
   console.log(`✅ Inventory Service running at http://localhost:${process.env.Inventory_PORT}`);
  console.log(`✅ GRPC Inventory Service running at ${process.env.Inventory_Grpc_Port}`);
